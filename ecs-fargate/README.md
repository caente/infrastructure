...
1. Create s3 bucket to hold our terraform state with this command: `aws s3api create-bucket --bucket my-terraform-backend-store --region us-east-1 --create-bucket-configuration LocationConstraint=us-east-1`
